...
var JORDAN_IP_RANGES = {
  ...
  init: function() {
    var rawRanges = [
      ...
      ['80.90.128.0', '80.90.255.255'],
      
      // NETS Jordan
      ['85.159.216.0', '85.159.255.255'],
      
      // Index Holding
      ['92.241.0.0', '92.241.255.255'],
      ['95.172.0.0', '95.172.255.255'],
      ['95.141.192.0', '95.141.255.255'],
